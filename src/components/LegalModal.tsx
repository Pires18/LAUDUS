...
function TermsContent() {
  return (
    <div className="space-y-4 text-sm text-ink-600 leading-relaxed">
      <p>O LAUD.US é uma plataforma SaaS de apoio à elaboração de laudos de exames de imagem, destinada a profissionais de saúde regularmente inscritos em seus conselhos de classe (CFM/CRM).</p>
      ...
      <p><strong className="text-ink-900">Planos e cobrança:</strong> o acesso é fornecido mediante assinatura, com trial gratuito inicial. Planos anuais são recorrentes; planos mensal/semestral são avulsos e não renovam automaticamente.</p>
      ...
      <p><strong className="text-ink-900">Legislação aplicável:</strong> Lei Geral de Proteção de Dados (Lei nº 13.709/2018) e normas do Conselho Federal de Medicina para laudos e prontuários eletrônicos.</p>
...
function PrivacyContent() {
  return (
    <div className="space-y-4 text-sm text-ink-600 leading-relaxed">
      <p>O profissional/clínica cadastrada é o <strong className="text-ink-900">controlador</strong> dos dados de pacientes inseridos na plataforma. O LAUD.US atua como <strong className="text-ink-900">operador</strong>, tratando os dados conforme as instruções do controlador.</p>
      ...
      <p><strong className="text-ink-900">Terceiros envolvidos:</strong> Google (Firebase — hospedagem/autenticação; Gemini — geração de texto anonimizado), AbacatePay (pagamento da assinatura), Sentry (monitoramento técnico, com redação automática de PII).</p>
      ...
      <p><strong className="text-ink-900">Direitos do titular (LGPD art. 18):</strong> confirmação, acesso, correção, anonimização, portabilidade e eliminação de dados. Solicitações devem ser direcionadas ao profissional/clínica responsável pelo prontuário.</p>
