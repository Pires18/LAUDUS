...
export const LEGAL_TERMS_VERSION = '2.0';
...
function TermsContent() {
  return (
    <div className="space-y-4 text-sm text-ink-600 leading-relaxed">
      <p>O LAUD.US é uma plataforma SaaS operada por <strong className="text-ink-900">Kist Serviços Médicos LTDA</strong> (CNPJ 46.706.765/0001-42), de apoio à elaboração de laudos de exames de imagem, destinada a profissionais de saúde regularmente inscritos em seus conselhos de classe (CFM/CRM).</p>
      ...
      <p><strong className="text-ink-900">Propriedade intelectual:</strong> o software e sua marca pertencem à Kist Serviços Médicos LTDA. Os dados de pacientes e laudos permanecem de titularidade do usuário/instituição responsável.</p>
...
function PrivacyContent() {
  return (
    <div className="space-y-4 text-sm text-ink-600 leading-relaxed">
      <p>O profissional/clínica cadastrada é o <strong className="text-ink-900">controlador</strong> dos dados de pacientes inseridos na plataforma. A <strong className="text-ink-900">Kist Serviços Médicos LTDA</strong> (CNPJ 46.706.765/0001-42) atua como <strong className="text-ink-900">operadora</strong>, tratando os dados conforme as instruções do controlador.</p>
