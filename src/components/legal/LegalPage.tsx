...
export function LegalPage({ doc }: Props) {
  ...
  return (
    <div className="min-h-screen w-full bg-white font-sans text-ink-900 flex flex-col" style={{ colorScheme: 'light' }}>
      {/* ── Nav mínima ── */}
          ...
          <article className="legal-article">
            ...
            {doc === 'privacy' && (
              <div className="mt-12 pt-8 border-t-2 border-ink-100">
                <h1 className="text-xl font-black text-ink-900 mb-1 tracking-tight">Anexo — Política de Retenção e Expurgo de Dados</h1>
      ...
      <style>{`
        @media print {
          .legal-nav, .legal-footer, .legal-doc-header a, .legal-doc-header .flex.gap-1 { display: none !important; }
