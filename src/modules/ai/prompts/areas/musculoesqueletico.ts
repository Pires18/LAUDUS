export function getMusculoesqueleticoPrompt(templateName: string, clinicalIndication: string, anamnesis: string): string {
  ...
  const sec_base = `MÓDULO MUSCULOESQUELÉTICO E MEDICINA ESPORTIVA — VERSÃO FINAL v13.0
...
export const musculoesqueleticoPrompt = getMusculoesqueleticoPrompt;
