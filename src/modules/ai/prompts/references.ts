...
export const CLASSIFICATION_REFS = {
  ...
  fetalFgr: { short: 'Delphi/Barcelona', cite: 'Consenso Delphi (Gordijn, 2016) · Protocolo de Barcelona (Figueras-Gratacós)', link: 'https://obgyn.onlinelibrary.wiley.com/doi/10.1002/uog.15884' },
  fetalGrowthVelocity: { short: 'GrowthVelocity', cite: 'Velocidade de crescimento fetal (Hugh & Gardosi, UOG 2022)', link: 'https://perinatal.org.uk/growthvelocity' },
  ophthalmicPE: { short: 'AO-PE', cite: 'Doppler de artéria oftálmica na predição de pré-eclâmpsia (Sarno/Nicolaides, AJOG 2020)', link: 'https://www.ajog.org/article/S0002-9378(20)31375-2/fulltext' },
