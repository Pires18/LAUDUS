      ...
      >
        ...
        <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-white z-10 relative shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-base font-black text-slate-900 leading-tight">Novo Agendamento</h2>
        ...
        {/* Sticky Steps bar */}
        <div className="bg-slate-50 px-6 py-3 flex items-center gap-2.5 border-b border-slate-100 shrink-0">
          {[
              ...
              <div key={s.step} className="flex items-center gap-2.5">
                ...
                >
                  <div className={classNames(
                    ...
                    isActive || isPast ? "bg-slate-900 text-white" : "bg-slate-200 text-slate-400"
                  )}>
                    {s.step}
                  </div>
                ...
                {selectedPatient ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="font-black text-slate-900 text-xs uppercase tracking-widest">Selecione o Paciente</h3>
                      <button 
                        type="button"
                      ...
                      <div className="space-y-4 p-5 rounded-[1.5rem] bg-slate-50 border border-slate-200 shadow-sm">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-700">
                          <div className="sm:col-span-2">
                            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Nome Completo *</label>
                            <input
                              type="text"
                              placeholder="Ex: Maria Oliveira Santos"
                              className="w-full h-11 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900"
                              value={newPatientName}
                              onChange={(e) => setNewPatientName(e.target.value)}
                            />
                          </div>
                          <div>
                            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Nascimento (Opcional)</label>
                            <input
                              type="date"
                              className="w-full h-11 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900"
                          ...
                          <div>
                            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Sexo</label>
                            <select
                              className="w-full h-11 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900 cursor-pointer"
                          ...
                          <div>
                            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Telefone</label>
                            <input
                              type="tel"
                          ...
                          <div>
                            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">CPF</label>
                            <input
                              type="text"
                          ...
                          <div className="sm:col-span-2">
                            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Convênio / Plano de Saúde</label>
                            <input
                              type="text"
                      ...
                      <div className="space-y-3">
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full h-12 pl-12 pr-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-slate-400 focus:bg-white outline-none font-bold text-sm text-slate-900"
                            value={patientSearch}
                ...
                <div className="space-y-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-11 pl-12 pr-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-slate-900 text-xs"
                  ...
                  <div className="grid grid-cols-1 gap-2 max-h-[220px] overflow-y-auto pr-1.5 custom-scrollbar">
                    {filteredTemplates.map(t => (
                      <button
                        ...
                        className="w-full flex items-center justify-between p-3.5 rounded-xl bg-white border border-slate-200 hover:border-slate-400 transition-all text-left shadow-sm group"
                      >
                        <div className="flex items-center gap-3">
            ...
            {modalStep === 3 && selectedTemplate && (
              ...
              >
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 shadow-sm">
                  <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest leading-none">Procedimento Selecionado</p>
                  <h4 className="text-xs font-black text-slate-900 mt-1">{selectedTemplate.name}</h4>
                </div>

                {/* Form fields: Priority, Doctor, Insurance */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 border border-slate-200 rounded-xl bg-slate-50/30">
                  <div>
                ...
                <div className="flex flex-col space-y-2">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest block">Data do Exame</label>
                  <input
                    type="date"
                ...
                <div className="space-y-2">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest block ml-0.5">Escolha um Horário Disponível</label>
                  ...
                  {slots.length === 0 ? (
                    ...
                    <div className="space-y-3 max-h-[160px] overflow-y-auto p-1.5 border border-slate-200 rounded-xl custom-scrollbar bg-white">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-wider">{appointmentNotes.length}/500</span>
                  </div>
                  <textarea
        ...
        <div className="px-6 py-5 border-t border-slate-100 bg-white flex items-center justify-between shrink-0 z-10">
          {modalStep > 1 ? (
            <button 
              ...
              className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400 hover:text-slate-900 uppercase tracking-widest border-none bg-transparent"
            >
              Voltar
            </button>
          ) : (
