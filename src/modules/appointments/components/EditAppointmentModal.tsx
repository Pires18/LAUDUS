...
export function EditAppointmentModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-300">
      ...
      >
        {/* Header */}
        <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-white z-10 relative shrink-0">
          <div className="flex items-center gap-4">
            <div className="relative w-10 h-10 rounded-xl bg-slate-900 text-white flex items-center justify-center shadow-sm">
              <Edit size={18} />
            </div>
            <div>
              <h2 className="text-base font-black text-slate-900 leading-tight">Editar Agendamento</h2>
              <div className="flex items-center gap-1.5 mt-0.5">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"></span>
                <p className="text-[9px] text-slate-500 font-bold uppercase tracking-[0.2em]">Registro ID: {appointment.id}</p>
              </div>
            </div>
          </div>
          <button 
        ...
        {/* Content Body */}
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar grid grid-cols-1 lg:grid-cols-2 gap-6 bg-slate-50/50">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-slate-100 text-slate-700 hover:bg-slate-200 font-bold text-[9px] uppercase tracking-wider transition-all"
                >
                ...
                <div className="space-y-3 p-3 bg-slate-50 border border-slate-200 rounded-xl">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-9 pl-9 pr-3 bg-white border border-slate-200 rounded-lg focus:border-slate-400 outline-none text-xs font-bold text-slate-900"
                  ...
                  <div className="space-y-1.5 max-h-[150px] overflow-y-auto pr-1.5 custom-scrollbar">
                    {filteredPatients.map(p => (
                      <button
                        ...
                        className="w-full flex items-center justify-between p-2 rounded-lg bg-white border border-slate-200 hover:border-slate-400 transition-all text-left shadow-sm text-xs font-bold"
                      >
                        <span className="truncate">{p.name}</span>
                        <span className="text-[8px] text-slate-400 font-mono shrink-0 ml-2">{p.id}</span>
                      </button>
                    ))}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-700">
                <div className="sm:col-span-2">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">Nome Completo *</label>
                  <input
                    type="text"
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900"
                    value={patientName}
                    onChange={(e) => setPatientName(e.target.value)}
                  />
                </div>
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">Nascimento</label>
                  <input
                    type="date"
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900"
                ...
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">Sexo</label>
                  <select
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900 cursor-pointer"
                    value={patientGender}
                ...
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">Telefone</label>
                  <input
                    type="tel"
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900"
                    value={patientPhone}
                ...
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">CPF</label>
                  <input
                    type="text"
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl focus:border-slate-400 outline-none font-bold text-xs text-slate-900"
                    value={patientCPF}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-700">
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-10 px-2 bg-white border border-slate-200 rounded-xl font-bold text-xs focus:border-slate-400 outline-none"
                  >
                ...
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest block mb-1">Convênio</label>
                  <input
                    type="text"
                    value={appointmentInsurance}
                    onChange={(e) => setAppointmentInsurance(e.target.value)}
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl font-bold text-xs focus:border-slate-400 outline-none"
                  />
                </div>
                <div className="sm:col-span-2">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest block mb-1">Médico Solicitante (Opcional)</label>
                  <input
                    type="text"
          ...
          <div className="space-y-4">
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">Unidade de Atendimento</label>
                  <select
                    ...
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl font-bold text-xs text-slate-900 focus:border-slate-400 outline-none"
                  >
                    {clinics.map(c => (
                ...
                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-1 block">Procedimento (Máscara)</label>
                  
                  {selectedTemplate ? (
                    <div className="flex items-center justify-between bg-slate-50 p-2.5 rounded-xl border border-slate-200 shadow-inner mb-2">
                      <div className="flex items-center gap-2">
                        <AreaIcon area={selectedTemplate.area} size={12} className="text-slate-400" />
                        <span className="text-xs font-bold text-slate-900">{selectedTemplate.name}</span>
                      </div>
                      <button
                        type="button"
                        onClick={() => setSelectedTemplateId('')}
                        className="p-1 hover:bg-slate-200 rounded text-slate-450 hover:text-slate-900"
                      >
                        <X size={12} />
                      </button>
                    </div>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex gap-1 overflow-x-auto pb-1 scrollbar-hide">
                        <button
                          ...
                          className={classNames(
                            ...
                            selectedArea === 'todas' ? "bg-slate-900 border-slate-900 text-white shadow-sm" : "bg-slate-50 text-slate-500 border-slate-200"
                          )}
                        >
                          Todas
                        </button>
                        {EXAM_AREAS.map(area => (
                          <button
                            ...
                            className={classNames(
                              ...
                              selectedArea === area.id ? "bg-slate-900 border-slate-900 text-white shadow-sm" : "bg-slate-50 text-slate-500 border-slate-200"
                            )}
                          >
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full h-9 pl-9 pr-3 bg-white border border-slate-200 rounded-lg focus:border-slate-400 outline-none font-bold text-slate-900 text-xs"
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl font-bold text-xs focus:border-slate-400 outline-none shadow-sm"
                  />
                </div>

                <div>
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest block mb-1">Horário</label>
                  ...
                  {slots.length === 0 ? (
                    ...
                    <div className="space-y-3 max-h-[140px] overflow-y-auto p-2 border border-slate-200 rounded-xl custom-scrollbar bg-white">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
              <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest block ml-0.5">Indicação Clínica / Observações</label>
              <textarea
        ...
        {/* Footer */}
        <div className="px-6 py-5 border-t border-slate-100 bg-white flex items-center justify-between shrink-0 z-10">
          <button
            type="button"
            onClick={onClose}
