...
import { Loader2, AlertCircle, Eye, X, UserCog, Sparkles, BookOpen, Search, ChevronDown, Zap, FileText, Star, Printer } from 'lucide-react';
    ...
    <>
      ...
      {isAdmin && showPromptPreview && template && patient && (
        <PromptPreviewModal
          ...
          onCopied={() => showToast('Prompt copiado!', 'success')}
        />
      )}
