...
const MORFOLOGICA_1T = (): StructuredSection[] => [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'risco_trissomias', label: 'Risco combinado de trissomias (FMF)', kind: 'calc', calcId: 'fmf-trisomy-risk', fullWidth: true, hint: 'calculadora em validação — conferir antes de laudar' },
    ],
  },
  ...ANATOMIA_1T(),
  {
    ...
    fields: [
      ...
      { id: 'risco_pe', label: 'Risco de pré-eclâmpsia (FMF)', kind: 'calc', calcId: 'fmf-preeclampsia-risk', fullWidth: true, hint: 'calculadora em validação — conferir antes de laudar' },
    ],
  },
  PLACENTA(),
  LIQUIDO(),
